...
plot 'stats_mse.txt' using 1:2 with lines title 'MSE lvl 3', 'stats_mse.txt' using 1:3 with lines title 'MSE lvl 2', 'stats_mse.txt' using 1:4 with lines title 'MSE lvl 1'
